...
\caption{Agnostic visual-bridge robustness battery. These checks support anti-shortcut and regression claims for the frozen real probes and synthetic controls; they do not claim universal real-world primitive correctness.}
\label{tab:sppa-visual-bridge-robustness}
\begin{tabularx}{\linewidth}{@{}L{0.19\linewidth}L{0.11\linewidth}rL{0.26\linewidth}L{0.10\linewidth}rY@{}}
\toprule
Check & Scope & N & Metric & Status & Warn. & Boundary \\
\midrule
