...
Documento dedicado: [`docs/WORKFLOWS.md`](docs/WORKFLOWS.md)
...
- `..\papers\semantic_proxy_3d` -> `semantic_proxy_3d`
- `..\papers\pipeline_a_telemetry` -> `pipeline_b_telemetry_vrih`
- `..\papers\porce_collision_evasion\Path_Planning_and_Obstacle_Avoidance_Real_time_Collision_Evasion` -> `path_planning_collision_evasion`
...
- `..\papers\semantic_proxy_3d\semantic_proxy_3d_paper.tex` con `pdflatex/bibtex/pdflatex/pdflatex`.
- `..\papers\pipeline_a_telemetry\pipeline_b_concept.tex` con `xelatex` repetido.
