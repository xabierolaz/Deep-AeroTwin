...
def main() -> int:
    root = repo_root()
    default_raw = root.parent / "papers" / "porce_collision_evasion" / "figuras_paper_unreal_generadas" / "yolo_crossing_precheck" / "raw"
    default_out = root.parent / "papers" / "porce_collision_evasion" / "figuras_paper_unreal_generadas" / "yolo_crossing_precheck"
