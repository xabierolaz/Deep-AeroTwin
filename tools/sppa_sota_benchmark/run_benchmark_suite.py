...
TRIPOSR_PY = ROOT / "third_party" / "sota_3d_generators" / "_venvs" / "triposr" / "Scripts" / "python.exe"
OPENAI_TEXT3D_PY = ROOT / "third_party" / "sota_3d_generators" / "_venvs" / "openai_text3d" / "Scripts" / "python.exe"
...
def main() -> None:
    ...
    run_dir = ROOT / "experiments" / "sppa_sota_benchmark" / "runs" / args.run_id
    ...
    commands: dict[str, tuple[list[str], int]] = {
        "sppa": (
            [
                ...
                "--objects-csv",
                "experiments/sppa_sota_benchmark/inputs/objects.csv",
                "--output-dir",
                f"experiments/sppa_sota_benchmark/runs/{args.run_id}/outputs/sppa_current_template",
            ],
            120,
        ),
        "triposr": (
            [
                ...
                "--objects-csv",
                "experiments/sppa_sota_benchmark/inputs/objects_rgba.csv",
                "--output-dir",
