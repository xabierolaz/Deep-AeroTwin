...
def main() -> None:
    ...
    emit("SPPA_BENCH_RUN", {"model": "sppa_current_template", "gpu_before": gpu_snapshot()})
    for item in objects:
        label = item["label"]
