...
def main() -> None:
    ...
    ax.scatter([init_xy[0]], [init_xy[1]], marker="^", s=65, color=g.INK, zorder=9, label="UAS")
    ...
    fig, ax = plt.subplots(figsize=g.FIG1_PANEL_FIGSIZE)
    _base_panel(ax, d)
    ax.scatter([d["detect_xy"][0]], [d["detect_xy"][1]], marker="^", s=65, color=g.INK, zorder=9, label="UAS")
    g.draw_obstacles(ax, d["det_obs"], g.TOWER, radius=True, label="Tower detection")
    ...
    g.draw_obstacles(ax, d["det_detail_obs"], g.TOWER, radius=True, label="Tower")
    ...
    ax.scatter([d["plan_origin_xy"][0]], [d["plan_origin_xy"][1]], marker="^", s=65, color=g.INK, zorder=9, label="UAS")
    g.draw_obstacles(ax, d["eva_obs"], g.TOWER, radius=True, label="Tower detection")
    ...
    ax.plot(flown["east"], flown["north"], color=g.FLOWN, linewidth=1.2, alpha=0.75, label="Flown path")
    ax.scatter([d["mid_evasion_xy"][0]], [d["mid_evasion_xy"][1]], marker="^", s=65, color=g.INK, zorder=9, label="UAS")
    g.draw_obstacles(ax, d["eva_obs"], g.TOWER, radius=True, label="Tower")
