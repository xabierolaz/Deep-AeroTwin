...
OBS_STATIC_CLASS_NAMES = _env_list("PORCE_OBS_STATIC_CLASS_NAMES", "tower,cow")
...
VISION_DEFAULT_MODEL_PATH = _resolve_path(
    os.path.join(_project_root, "yolo", "weights", "yolo_unreal_unrealScene_v1_best_e23_2026-02-18.pt")
)
