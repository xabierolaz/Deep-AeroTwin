...
OBS_TRACK_TTL_STATIC_S = max(0.1, _env_float("PORCE_OBS_TRACK_TTL_STATIC_S", 180.0))
...
EVASION_ACTIVE_REPLAN_DISTANCE_M = max(0.1, _env_float("PORCE_EVASION_ACTIVE_REPLAN_DISTANCE_M", 12.0))
EVASION_PLANNER_OBS_MAX_DISTANCE_M = max(1.0, _env_float("PORCE_EVASION_PLANNER_OBS_MAX_DISTANCE_M", 55.0))
EVASION_PLANNER_OBS_MAX_COUNT = max(1, _env_int("PORCE_EVASION_PLANNER_OBS_MAX_COUNT", 20))
...
EVASION_FAILSAFE_ESCALATE_ENABLE = _env_bool("PORCE_EVASION_FAILSAFE_ESCALATE_ENABLE", True)
...
EVASION_FAILSAFE_ESCALATE_ACTION = str(
    os.environ.get("PORCE_EVASION_FAILSAFE_ESCALATE_ACTION", "RTL")
).strip().upper() or "RTL"
